...
class FtxClient:
    ...
    def get_ohlcv(self, market: str,resolution:str) -> dict:
    ...
    def set_leverage(self) -> List[dict]:
        return self._post(f'/account/leverage', {'leverage': 10})
    
    def convert(self) -> List[dict]:
        return self._post(f'/otc/quotes', {"fromCoin": "ETH","toCoin": "USD","size": 0.001})
    
    def subaccounts_transfer(self) -> List[dict]:
        return self._post(f'/subaccounts/transfer', {"coin": "USD","size": 1,"source": "ReadytoAdd","destination": "Main Account",})
