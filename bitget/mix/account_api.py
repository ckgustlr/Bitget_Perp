...
class AccountApi(Client):
    ...
    :return:
    '''
    def account(self, symbol, productType, marginCoin):
        params = {}
    ...
    def leverage_v2(self, symbol, productType, marginCoin, leverage, holdSide=''):
        params = {}
        if symbol and marginCoin:
            print(symbol,marginCoin)
            params["symbol"] = symbol
            params["productType"] = productType
            params["marginCoin"] = marginCoin
            params["leverage"] = leverage
    ...
    def leverage_v3(self, symbol, productType, marginCoin, shortLeverage, longLeverage):
        params = {}
        if symbol and marginCoin:
            print(symbol,marginCoin)
            params["symbol"] = symbol
            params["productType"] = productType
            params["marginCoin"] = marginCoin
            params["shortLeverage"] = shortLeverage 
            params["longLeverage"] = longLeverage 
            print(params)
            return self._request_with_params(POST, "/api/v2/mix/account/set-leverage", params)
        else:
            return "pls check args"
    ...
    :return:
    '''
    def margin(self, symbol, marginCoin, productType, amount, holdSide=''):
        params = {}
        if symbol and marginCoin:
            params["symbol"] = symbol
            params["marginCoin"] = marginCoin
            ...
            return self._request_with_params(POST, MIX_ACCOUNT_V2_URL + '/set-margin', params)
        else:
            return "pls check args"
