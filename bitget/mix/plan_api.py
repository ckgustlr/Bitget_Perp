...
class PlanApi(Client):
    ...
    def cancel_plan_v2(self, orderId, productType):
        params = {}
        if productType:
            params["planType"] = productType
            params["orderId"] = orderId
    ...
    def current_plan_v2(self, planType,productType):
        params = {}
        if planType:
            params["planType"] = planType
    ...
    def modify_tpsl_plan_v2(self, symbol, marginCoin, productType, orderId, triggerPrice,executePrice,size):
        params = {}
        if symbol:
            params["symbol"] = symbol
            params["marginCoin"] = marginCoin
            ...
            params["executePrice"] = executePrice
            params["size"] = size
            return self._request_with_params(POST, "/api/v2/mix/order/modify-tpsl-order", params)
        else:
            return "pls check args "
        
    def place_tpsl_v2(self, symbol, marginCoin, productType, planType, triggerPrice,executePrice, holdSide,size):
        params = {}
        if symbol:
            params["symbol"] = symbol
            params["marginCoin"] = marginCoin
    ...
    #def history_plan_v2(self, symbol, startTime, endTime, pageSize, lastEndId='', isPre=False, isPlan='plan'):
    def history_plan_v2(self, symbol,planType,productType,startTime, endTime):
        params = {}
        if symbol:
            params["symbol"] = symbol
