...
class OrderApi(Client):
    ...
    :return:
    '''
    def place_order(self, symbol, marginCoin,marginMode, productType,size, side, tradeSide,orderType, price='', clientOrderId='', timeInForceValue='normal', presetStopSurplusPrice='', presetStopLossPrice=''):
        params = {}
    ...
    :return:
    '''
    def modify_Order(self, symbol, orderId, clientOid, newClientOid, size, price='', presetTakeProfitPrice='', presetStopLossPrice=''):
        params = {}
        if symbol:
            params["symbol"] = symbol
            ...
            params["presetStopLossPrice"] = presetStopLossPrice
            return self._request_with_params(POST, MIX_ORDER_V1_URL + '/modifyOrder', params)
        else:
            return "pls check args "
    ...
    :return:
    '''
    def Get_All_OpenOrder(self, productType,marginCoin):
        params = {}
        if productType:
            params["productType"] = productType
            params["marginCoin"] = marginCoin
