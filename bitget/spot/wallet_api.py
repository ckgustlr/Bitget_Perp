...
class WalletApi(Client):
   ...
   :return:
    ...
    def subtransfer(self, fromType, toType, amount, coin, clientOid,fromUserId,toUserId):
        params = {}
        if fromType and toType and amount and coin and clientOid and fromUserId and toUserId:
            params["fromType"] = fromType
            params["toType"] = toType
            params["amount"] = amount
            params["coin"] = coin
